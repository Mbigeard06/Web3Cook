...
export class DexFactoryInitialisator{
    ...
    public static initializeFactory(dexFactory : DexFactory): void{
        ...
        dexFactory.registerDex("UniswapV3Base", new UniswapV3Base("UniswapV3Base",3,'0x1F98431c8aD98523631AE4a59f267346ea31F984'))
        //Mainet eth
        dexFactory.registerDex("UniswapV3Eth", new UniswapV3Eth("UniswapV3Eth",3,'0x1F98431c8aD98523631AE4a59f267346ea31F984'))
    }
}